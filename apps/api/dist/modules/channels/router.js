...
import { getAuthUrl, exchangeCodeForTokens, getChannelInfo, saveConnectedChannel, } from "./youtube.js";
const router = Router();
...
router.get("/youtube/callback", async (req, res) => {
    ...
    if (oauthError) {
        ...
        const frontendUrl = `${env.WEB_ORIGIN}/app/canais?error=${encodeURIComponent(oauthError)}`;
