-- Migração 001: Schema inicial (tabelas base)
-- Executada primeiro para criar a estrutura base
...
-- Plataformas de marketing suportadas
...
-- Contas sociais conectadas (genérico para todas as plataformas)
create table if not exists public.social_accounts (
  ...
  token_reference text, -- refresh token criptografado
...
-- Assets de conteúdo (arquivos enviados)
...
-- Posts agendados (compatibilidade com dashboard existente)
...
-- Targets de publicação por plataforma
